module github.com/robinkb/cascade/tools/buf
...
replace google.golang.org/genproto v0.0.0-20220519153652-3a47de7e79bd => google.golang.org/genproto v0.0.0-20260519071638-aa98bba5eb94
